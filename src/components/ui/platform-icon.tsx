...
export const PlatformIcon = ({ platform, className = "h-4 w-4" }: PlatformIconProps) => {
  switch (platform.toLowerCase()) {
    ...
    case "linkedin":
      return <div className={`${className} bg-blue-700 rounded-sm flex items-center justify-center text-white text-xs font-bold`}>in</div>;
    case "twitch":
    ...
    case "snapchat":
      return <div className={`${className} bg-yellow-400 rounded-lg flex items-center justify-center text-white text-xs font-bold`}>S</div>;
    case "pinterest":
